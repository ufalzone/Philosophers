...
/*   Updated: 2025/03/05 12:35:23 by ufalzone         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	create_philo_thread(t_global *global)
{
	...
	while (i < global->nb_philo)
	{
		...
		pthread_create(&global->philo_array[i]->id_thread, NULL,
			(void *)routine, global->thread_data[i]);
		i++;
	}
}
...
static void	init_exec_philo(t_global *global)
{
	...
	pthread_mutex_init(&global->mutex_start, NULL);
...
void	exec_philo(t_global *global)
{
	...
	pthread_create(&global->monitor_thread, NULL, (void *)monitor_thread,
		global);
