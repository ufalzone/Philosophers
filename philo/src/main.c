...
/*   Updated: 2025/02/27 19:32:37 by ufalzone         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	debug_print_global(t_global *global)
{
	...
	{
		printf("Philosophe %d: ID_Thread: %ld, Dernier repas: %ld, Nombre de repas: %d, Adresse de la fourchette gauche: %p, Adresse de la fourchette droite: %p\n",
